...
class StripeTestRunner
{
    ...
    {
        $live = self::getenv('STRIPE_TEST_LIVE');
        $override = self::getenv('STRIPE_TEST_OVERRIDE');
        ...
        $explain = self::getenv('STRIPE_TEST_EXPLAIN');
...
class_alias('StripeTestRunner', 'Runner');
class_alias('StripeHelpers', 'Helpers');
