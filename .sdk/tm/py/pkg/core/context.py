...
from projectname_sdk.core.control import StripeControl
...
class StripeContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(rp, StripeResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return StripeError(code, msg, self)
