...
class StripeFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; StripeSDK/1.0)';
    ...
    public static function call(StripeContext $ctx, string $fullurl, array $fetchdef): array
    {
