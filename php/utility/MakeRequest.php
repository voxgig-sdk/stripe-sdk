...
// Stripe SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class StripeMakeRequest
{
    public static function call(StripeContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new StripeResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new StripeResponse($fetched);
        } else {
