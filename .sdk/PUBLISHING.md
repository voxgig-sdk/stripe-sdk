...
|---|---|---|
| `js/` | @voxgig-sdk/stripe-js | `.github/workflows/publish-js.yml` |
| `ts/` | @voxgig-sdk/stripe | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/stripe-js \
      --repository voxgig-sdk/stripe-sdk \
      --file publish-js.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/stripe-js` shows it, and
`npm trust revoke @voxgig-sdk/stripe-js --id=<id>` removes it.
