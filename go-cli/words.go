...
func registerSDKWords(r *eng.Registry, client *sdk.StripeSDK) {
...
func runOp(client *sdk.StripeSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
