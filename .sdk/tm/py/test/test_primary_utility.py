...
from projectname_sdk import StripeSDK
from projectname_sdk.core.spec import StripeSpec
from projectname_sdk.core.result import StripeResult
from projectname_sdk.core.response import StripeResponse
from projectname_sdk.core.operation import StripeOperation
from projectname_sdk.core.error import StripeError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import StripeBaseFeature
...
class TestPrimaryUtility:
    ...
    def test_exists(self):
        client = StripeSDK.test(None, None)
    ...
    def test_feature_init_basic(self):
        init_client = StripeSDK.test(None, None)
        ...
        class TestInitFeature(StripeBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(StripeBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = StripeSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = StripeSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = StripeSDK.test(None, setup_opts)
