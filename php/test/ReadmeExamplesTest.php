...
// Stripe SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (StripeSDK::test)
...
{
    private const SDK_CLASS = 'StripeSDK';
    ...
    private const SDK_BASE = 'stripe_sdk';
