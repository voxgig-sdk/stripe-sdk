...
class StripeRatelimitFeature extends StripeBaseFeature
{
    ...
    private function _acquire(StripeContext $ctx): void
    {
    ...
    private function _track(StripeContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
