# Stripe SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions StripeSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both StripeSDK(...) and StripeSDK.test(...) become
#      StripeSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "stripe_sdk"
_SDK_CLASS = "StripeSDK"
