...
(0, node_test_1.describe)('SessionDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-session', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-session', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-session', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-session', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function liveScenariosActive() { return false && process.env.STRIPE_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    const client = new __1.StripeSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=SessionDirect.test.js.map