...
func NewSessionEntity(client *core.StripeSDK, entopts map[string]any) *SessionEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *SessionEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// SessionLoadMatch and returns an Session. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *SessionEntity) LoadTyped(reqmatch SessionLoadMatch, ctrl map[string]any) (Session, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Session{}, err
	}
	return typedFrom[Session](res), nil
}
...
func (e *SessionEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// SessionCreateData and returns an Session. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *SessionEntity) CreateTyped(reqdata SessionCreateData, ctrl map[string]any) (Session, error) {
