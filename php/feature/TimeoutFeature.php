...
class StripeTimeoutFeature extends StripeBaseFeature
{
    ...
    private function _with_timeout(StripeContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(StripeContext $_ctx, float $ms): void
    {
        $client = $this->client;
