...
// Stripe SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class StripeTestFeature extends StripeBaseFeature
{
    ...
    public function init(StripeContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (StripeContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (StripeContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(StripeContext $ctx, $op, $args): array
    {
