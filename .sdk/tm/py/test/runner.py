...
class StripeTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = StripeTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = StripeTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = StripeTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
